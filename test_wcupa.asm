...
_test_wcupa:     file format elf32-i386
...
int main(void) {
  ...
  11:	e8 0c 03 00 00       	call   322 <wcupa>
 ...
 349:	85 d2                	test   %edx,%edx
{
 ...
 377:	f7 f1                	div    %ecx
 379:	0f b6 92 6c 07 00 00 	movzbl 0x76c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 594:	e9 8f fe ff ff       	jmp    428 <printf+0x48>
          s = "(null)";
 599:	bb 64 07 00 00       	mov    $0x764,%ebx
        while(*s != 0){
 ...
 5b1:	a1 10 0a 00 00       	mov    0xa10,%eax
{
 ...
 5ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ef:	a3 10 0a 00 00       	mov    %eax,0xa10
}
 5f4:	5b                   	pop    %ebx
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 10 0a 00 00       	mov    %eax,0xa10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68f:	73 47                	jae    6d8 <malloc+0x98>
    ...
    if(p == freep)
 691:	39 05 10 0a 00 00    	cmp    %eax,0xa10
 ...
 6b6:	e8 f5 fe ff ff       	call   5b0 <free>
  return freep;
 6bb:	8b 15 10 0a 00 00    	mov    0xa10,%edx
 ...
 6e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6e7:	89 15 10 0a 00 00    	mov    %edx,0xa10
}
 ...
 6f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 10 0a 00 00 14 	movl   $0xa14,0xa10
 707:	0a 00 00 
 70a:	c7 05 14 0a 00 00 14 	movl   $0xa14,0xa14
 711:	0a 00 00 
    base.s.size = 0;
 714:	b8 14 0a 00 00       	mov    $0xa14,%eax
 719:	c7 05 18 0a 00 00 00 	movl   $0x0,0xa18
 720:	00 00 00 
